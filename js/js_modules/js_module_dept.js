	...
	$(document).ready(function(){
			...
			$.ajax({
				...
				success:function(data){					
					$("#fed_dept_no").val(data.DEPT_NO);
					$("#fed_dept_name").val(data.DEPT_NAME);
					$("#fed_dept_mgr_name").val(data.DEPT_MGR_NAME);
					$("#fed_dept_email").val(data.DEPT_EMAIL);
					$("#fed_dept_phone").val(data.DEPT_PHONE);
					$("#con_fed").fadeIn(900);
				}
			});
	});
