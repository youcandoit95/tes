...
<html lang="en">
	...
	<body class="<?php echo $bg; ?>">
		<div class="container">
			...
			?>
				<div class="span12">
					<div class="text-center alert alert-<?php echo $this->session->flashdata('class_alert'); ?>">
			...
			<img src="<?php echo base_url().'images/logo_pinet.png';?>" style="margin-top: 10%;" width=100>
			</div>
			<form class="form-signin" role="form" action="<?php echo site_url().'logins/c_login/login';?>" method="POST">
				<h2 class="form-signin-heading text-center">Sign In - PINET System</h2>
			...
			<div class="form-signin-footer">Copyright&copy; Prima Integrasi Network 2014.</div>
