<div class="row">
	...
	<div id="modal_reject_po_early" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
		<div class="modal-dialog">
			<form method="POST" action="<?php echo site_url().'hcis/c_hcis_absent_approval/reject_po_early'; ?>">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script type="text/javascript">
	var url_approve_po_early = "<?php echo site_url().'hcis/c_hcis_absent_approval/approve_po_early'; ?>";
</script>