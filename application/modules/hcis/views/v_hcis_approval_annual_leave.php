<div class="row">
			...
			<tbody>
				...
				foreach ($data_annual_leave as $d)
				{
					...
					<tr>
						...
						<td style="text-align:center;">
							<a href="#" onClick="approve_cuti(this.id)" id="approve_<?php echo $d['rcuti_no']; ?>" class="btn btn-xs btn-success">Approve</a>
	...
	<div id="modal_reject_cuti" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
		<div class="modal-dialog">
			<form method="POST" action="<?php echo site_url().'hcis/c_hcis_cuti_approval/reject_annual_leave'; ?>">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<script type="text/javascript">
	var url_approve_cuti = "<?php echo site_url().'hcis/c_hcis_cuti_approval/approve_annual_leave';?>";
</script>