...
var url_FED = "<?php echo site_url().'department/c_dept/GO_FED';?>";
var url_DEL = "<?php echo site_url().'department/c_dept/dept_delete';?>";
		...
		<div class="span6">
			...
			<div class="Admin_dataForm" id="FED">
				...
				<strong>Please update data correctly</strong>
					...
					<form method="POST" action="<?php echo site_url().'department/c_dept/dept_update';?>">
			...
			<div class="Admin_dataForm gone" id="FAD_dept">
				<form method="POST" action="<?php echo site_url().'department/c_dept/dept_new';?>">
