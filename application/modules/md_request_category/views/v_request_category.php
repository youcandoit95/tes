...
<!-- JS Modules -->	
<script type="text/javascript" src="<?php echo base_url().'js/js_modules/md_request_category.js';?>"></script>
<script type="text/javascript">
var base_url = "<?php echo base_url(); ?>"
var url_FED = "<?php echo site_url().'md_request_category/c_request_category/GO_FED';?>";
var url_DEL = "<?php echo site_url().'md_request_category/c_request_category/status_delete';?>";
var url_ACTV = "<?php echo site_url().'md_request_category/c_request_category/status_activate_ajax';?>";
</script>
	...
	<div class="backend_100">
		...
		<div class="span12">
			...
			<div class="Admin_dataButtonAdd <?php echo isset($error_msg)!="" ? "gone" : ""; ?>" style="text-align:left">
				<input type="button" class="btn btn-primary" id="GO_FAD" value="New Req. Category" onClick="openFAD()">
			</div>
			<!-- End Button New Data -->
			...
			<div class="Admin_dataForm gone" id="FED">
				...
				<strong>Please update data correctly</strong>
					...
					<form method="POST" action="<?php echo site_url().'md_request_category/c_request_category/request_category_update';?>">
					<table class="backend_form_100 span4" >
						<tr>
							<td colspan=2><h3><u>Edit Req. Category</u></h3></td>
						</tr>
						<tr>
							<td>Status Name</td><input type="hidden" name="reqCat_no" id="fed_reqCat_no">
							<td><input type="text" class="form" name="reqCat_name" id="fed_reqCat_name" value="<?php echo set_value('reqCat_name');?>" required=""></td>
						</tr>
						<tr>
			...
			<div class="Admin_dataForm <?php echo isset($error_msg)!="" ? "" : "gone"?>" id="FAD_dept">
				<div class="span12">
				<form method="POST" action="<?php echo site_url().'md_request_category/c_request_category/request_category_new';?>">
				<table class="backend_form_100 span4" >
					<tr>
						<td colspan=2><h3><u>New Req. Category</u></h3></td>
					</tr>
					<tr>
						<td>Req. Category Name</td>
						<td><input type="text" class="form" name="reqCat_name" id="reqCat_name" value="<?php echo set_value('reqCat_name');?>" required=""></td>
					</tr>
					<tr>
						<td colspan=2 align="center">
		...
		<div class="span12">
			...
			<table class="table table-striped table-bordered font-12 span5" id="example">
				<thead>
					<tr>
						<th style="text-align:center">Req. Category No.</th>
						<th style="text-align:center">Req. Category Name</th>
				...
				<tbody>
					...
					foreach ($data as $d)
					{
						...
						<tr id="data_row_<?php echo$n; ?>">
							<th style="text-align:center"><?php echo $d['CATEGORY_NO']==888 ? $d['CATEGORY_NO'] : $d['CATEGORY_NO'];?></th>
							
								<input type="hidden" id="data_record_<?php echo$n; ?>" value="<?php echo $d['CATEGORY_NO'];?>">
								<input type="hidden" id="data_delete_name_<?php echo$n; ?>" value="<?php echo $d['CATEGORY_NAME'];?>">
